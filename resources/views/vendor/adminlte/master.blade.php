...
<head>
    ...
    <meta name="description" content="ABSENT admin">
    <meta name="author" content="Caiser666">
...
@yield('title', config('adminlte.title', 'ABSENT admin'))
...
{{-- <script src="{{ asset('js/my/firebase.js') }}"></script> --}}
